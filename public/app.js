...
const translations = {
    es: {
        ...
        structAnatomy: "Anatomía formal",
        structActors: "Mapa de actores normativos",
        thActor: "Actor", thType: "Tipo", thObligations: "Obligaciones", thPowers: "Facultades", thEnforceability: "Exigibilidad",
        structFlow: "Flujo de responsabilidad",
        structMechanisms: "Mecanismos de exigibilidad",
        exclusionsTitle: "Análisis de omisiones y exclusiones implícitas",
        convTitle: "Análisis de convencionalidad",
        convBlock: "Bloque de convencionalidad",
        convGaps: "Tabla de brechas",
        thStandard: "Estándar internacional", thProvision: "Disposición ley", thGapType: "Tipo de brecha", thSeverity: "Gravedad", thArgument: "Argumentación",
        argTitle: "Construcción de argumentación teórica",
        argDesc: "Propuestas de argumentación estructuradas para litigio o cabildeo.",
        synthesisTitle: "Síntesis del análisis",
    ...
    en: {
        ...
        structAnatomy: "Formal anatomy",
        structActors: "Normative actors map",
        thActor: "Actor", thType: "Type", thObligations: "Obligations", thPowers: "Powers", thEnforceability: "Enforceability",
        structFlow: "Responsibility flow",
        structMechanisms: "Enforceability mechanisms",
        exclusionsTitle: "Analysis of omissions and implicit exclusions",
        convTitle: "Conventionality analysis",
        convBlock: "Conventionality block",
        convGaps: "Gaps table",
        thStandard: "International standard", thProvision: "Law provision", thGapType: "Gap type", thSeverity: "Severity", thArgument: "Argumentation",
        argTitle: "Construction of theoretical argumentation",
        argDesc: "Structured argumentation proposals for litigation or lobbying.",
        synthesisTitle: "Synthesis of the analysis",
